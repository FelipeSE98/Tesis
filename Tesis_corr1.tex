...
\begin{teorema} \label{Teo Courant-Fischer} (Teorema de Courant-Fischer) %%%% Teorema: Courant-Fischer
    Sea $A\in \mathcal{M}_{n\times n}(\mathbb{R})$ una matriz real simétrica, cuyos valores propios son $\lambda_1 \leq \lambda_2 \leq ...\leq \lambda_n$, y $\lbrace \boldsymbol{v}_1, \boldsymbol{v}_2,..., \boldsymbol{v}_n \rbrace$ sus vectores propios. Entonces,
    \begin{itemize}
        \item[(i)] \[

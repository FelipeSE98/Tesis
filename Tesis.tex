...
\begin{proof}[Demostración espectral del Teorema~\ref{szemeredi_regularity_lemma1}]
    ...
    \begin{equation} \label{eq_1 Spectral_Proof}
        \Tr(A) = \sum_{i=1}^{n} \lambda_{1}^{2} =  2e_G \leq n^{2}.
    \end{equation}
    ...
    Probaremos que la partición construida del conjunto de vértices del grafo\newline $\mathcal{P} =\lbrace V_0,V_1,...,V_M\rbrace$ es $\varepsilon$-regular. Comenzamos identificando los pares excepcionales. Para esto, sea $F = (f_{xy})$ y defina
    \begin{align*}

...
\begin{proof}[Primera demostración del Teorema \ref{Teorema_de_Roth}]
    ...
    \begin{figure}[h]
        ...
        \end{tikzpicture}
        \caption{Esquema de relación entre un triángulo en $G$ y una progresión aritmética de largo $3$ en $S$.}
    \end{figure}
...
\begin{proof}
    ...
    \begin{figure}[h]
        ...
        \end{tikzpicture}
        \caption{Ejemplo del emparejamiento generado por la clase de equivalencia asociada a $q=5$, y $S = \lbrace (1,2), (1,4), (2,2), (2,3), (3,3), (4,1), (4,4) \rbrace$.}
    \end{figure}
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \node at (-0.25,-0.75) {$d$};
        \end{tikzpicture}
        \caption{Esquema ilustrativo de la esquina formada en la demostración}
    \end{figure}

...
Dado un grafo $G = (V,E)$, un subconjunto $R\subset E$ es un \textbf{emparejamiento} en $G$ si no existe un par de aristas en $R$ que compartan algún vértice. Diremos que $R$ es un \textbf{emparejamiento inducido} si es un emparejamiento y toda arista de $G$ con un vértice en $V(R)$ es una arista en $R$, en donde $V(R)$ denota el conjunto de vértices de las aristas que componen a $R$.
...
En esta sección se entregarán dos demostraciones del teorema de Roth por medio del lema de regularidad de Szemerédi. La primera de ellas, se fundamenta con el Teorema \ref{Enunciado TRL}.

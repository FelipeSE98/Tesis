...
\begin{proof}
    ...
    \fs{Aquí quedé}Se escribe la cantidad de copias etiquetadas de $F$ en $G$ de manera conveniente y se utilizará la hipótesis de inducción como se muestra a continuación:

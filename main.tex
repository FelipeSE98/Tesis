...
\fs{Aquí quedé...}El último resultado es interesante debido a que podemos expresar la cantidad de caminatas cerradas de largo $k$ en un grafo mediante únicamente la suma de la $k$-ésima potencia de los valores propios de su matriz de adyacencia.\medskip

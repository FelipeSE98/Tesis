...
Una consecuencia directa de la proposición anterior, es que en cualquier grafo $G = ([n], E)$ con matriz de adyacencia $A$ se puede representar la cantidad total de caminatas cerradas de largo $t$ por medio de la traza, $\Tr(A^{t}) = \sum_{i=1}^{n}a_{ii}^{(t)}$. Con esto, note que $\Tr(A^{2}) = 2e_G$.\medskip

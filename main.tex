...
Finalmente, $\mathcal{P}_{n}\subset G^{n}$ es una propiedad de grafos si es cerrada bajo isomorfismos de grafos. Más aún, diremos que $G$ satisface la propiedad $\mathcal{P}_{n}$ \textbf{con alta probabilidad} si $\mathbb{P}(G\in\mathcal{P}_{n})\to 1$ cuando $n\to\infty$.
